...
image: ../images/blogs/Create_Table_As_Select.png
url: "/blog/create-table-as-select"
keywords: "create table as select, create table, postgresql, select, sql, query, table, create, as"
---

Dias atrás, precisei fazer criar uma tabela no PostgreSQL a partir de uma consulta SQL. Tarefa fácil, não fosse a ansiedade ou a idade, rs. Abri o [DBeaver](https://dbeaver.io/) e executei no console:
