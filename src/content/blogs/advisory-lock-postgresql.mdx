---
title: "Advisory Lock no PostgreSQL"
description: "Uma solução para evitar registros duplicados no PostgreSQL."
datetime: 2026-02-23T12:00:00
image: /src/assets/images/blogs/PostgreSQL.png
url: "/blog/advisory-lock-postgresql"
keywords: "advisory lock, postgresql, lock table, codeigniter 3, pg_try_advisory_xact_lock, desenvolvimento web, php"
---
...
O Advisory Lock controla a concorrência no nível lógico, não depende de índice, não bloqueia a tabela inteira. Ele impede que duas transações executem a mesma operação crítica ao mesmo tempo. 
